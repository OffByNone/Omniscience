...
class CompositionRoot {
    ...
    createTab(){
    	return new Tab(this._deviceServices, Eventer, tabs, new FilePicker(new FileUtils(ComponentFactory.createMimeService()), new FilePickerFactory(ComponentFactory), ComponentFactory.filePickerConstants(), new LocalFileFactory(ComponentFactory), windowUtils), new FileSharer(this._httpServer, new UrlProvider(UrlSdk), MD5));
    }
