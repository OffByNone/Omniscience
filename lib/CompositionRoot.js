...
class CompositionRoot {
    ...
    createTab(){
        return new Tab(this._deviceServices, Eventer, tabs, new FilePicker(ComponentFactory.createMimeService(), new FilePickerFactory(ComponentFactory), ComponentFactory.filePickerConstants(), new LocalFileFactory(ComponentFactory), windowUtils), new FileSharer(this._httpd, new UrlProvider(UrlSdk)));
    }
