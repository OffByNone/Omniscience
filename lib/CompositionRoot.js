...
const SearcherService = require('./Services/SearcherService');
...
const CompositionRoot = Class({
	...
	createDeviceLocatorService: function createDeviceLocatorService(){
		return new DeviceLocatorService( Emitter, MD5,
					...
					new SearcherService(Utilities, Emitter, Timer, MD5, new SSDPFactory(Emitter, Utilities, ComponentFactory)),
					new ListenerService(Utilities, Emitter, Timer, MD5, new SSDPFactory(Emitter, Utilities, ComponentFactory)),
					storage);
	},
