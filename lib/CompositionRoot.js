	...
	initialize: function initialize() {
		...
		this._deviceServices = new DeviceServices(defer, Emitter, this._fxosWebServer, new HTTPServer(new nsHttpServer(), Utilities),
				...
				new MediaRendererService(Emitter, defer,
					new AVTransportService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( xhr, defer, Emitter, this._fxosWebServer, Utilities ) ),
					new ConnectionManagerService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( xhr, defer, Emitter, this._fxosWebServer, Utilities ) ),
					new RenderingControlService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( xhr, defer, Emitter, this._fxosWebServer, Utilities ) )),
