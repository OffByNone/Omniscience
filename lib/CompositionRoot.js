...
const CompositionRoot = Class({
	initialize: function initialize() {
		this._deviceServices = new DeviceServices(defer, Emitter, new HTTPServer(new nsHttpServer(), Utilities),
				...
				new MediaRendererService(Emitter, defer,
					new AVTransportService( Emitter, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( xhr, defer ), defer ),
					new ConnectionManagerService( Emitter, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( xhr, defer ), defer ),
					new RenderingControlService( Emitter, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( xhr, defer ), defer )),
