...
const MediaServerService = require('./Services/Devices/MediaServerService');
const WFAService = require('./Services/Devices/WFAService');
...
const CompositionRoot = Class({
	initialize: function initialize() {
		...
		this._deviceServices = new DeviceServices(defer, Emitter, this._fxosWebServer, new HTTPServer(new nsHttpServer(), Utilities), Utilities,
				...
				new MediaRendererService(Emitter, defer,
					new AVTransportService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ),
					new ConnectionManagerService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ),
					new RenderingControlService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ) ),
				new MediaServerService(Emitter, defer,			
					new ConnectionManagerService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ),
					new ContentDirectoryService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ),
					new MediaReceiverRegistrarService ( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ) ),
				new WFAService( Emitter, defer, new WFAWLANConfigService(Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities, fetch ), ComponentFactory.createDOMParser(), Utilities ) ),
	...
	createDeviceLocatorService: function createDeviceLocatorService(){
		return new DeviceLocatorService( Utilities, Emitter, Timer, new SSDPFactory(Emitter, Utilities, ComponentFactory),
					new DeviceFactory(ComponentFactory.createDOMParser(), Request, defer, new MessageFactory(), this._deviceServices, Emitter, Utilities ));
	},
