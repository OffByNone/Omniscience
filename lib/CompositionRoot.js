	...
	initialize: function initialize() {
		...
		this._deviceServices = new DeviceServices(defer, Emitter, this._fxosWebServer, new HTTPServer(new nsHttpServer(), Utilities), Utilities,
				...
				new MediaRendererService(Emitter, defer,
					new AVTransportService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ),
					new ConnectionManagerService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ),
					new RenderingControlService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ) ),
				new MediaServerService(Emitter, defer,			
					new ConnectionManagerService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ),
					new ContentDirectoryService( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ),
					new MediaReceiverRegistrarService ( Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ) ),
				new WFAService( Emitter, defer, new WFAWLANConfigService(Emitter, defer, new SOAPService( Request, defer, ComponentFactory.createDOMParser(), Utilities), new SubscriptionService( defer, Emitter, this._fxosWebServer, Utilities ), ComponentFactory.createDOMParser() ) ),
