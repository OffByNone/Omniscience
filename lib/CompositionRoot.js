...
const CompositionRoot = Class({
    ...
    createDeviceLocatorService: function createDeviceLocatorService(){
        return new DeviceLocatorService( Emitter, MD5,
					...
					new ActiveSearcher(Utilities, Emitter, Timer, MD5, new SSDPFactory(Emitter, Utilities, ComponentFactory)),
					new PassiveSearcher(Utilities, Emitter, Timer, MD5, new SSDPFactory(Emitter, Utilities, ComponentFactory)),
