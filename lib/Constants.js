...
exports.tab = {
	js: ['./libs/jquery-2.1.3.min.js', './libs/bootstrap/js/bootstrap.min.js', './libs/angular.min.js', './libs/angular-route.min.js', './libs/md5.js', './libs/toastr/toastr.min.js', './omniscience.js',
		'./Directives.js', './controllers/DeviceController.js', './controllers/HomeController.js', './controllers/AboutController.js', './controllers/DeviceInfoController.js', './controllers/DeviceListController.js', './services/PubSub.js',
		'./controllers/IndexController.js', './controllers/DeviceSettingsController.js', './controllers/PlaylistController.js', './services/EventService.js', './services/PubSub.js', './controllers/ConnectionManager.js', './services/ConnectionManagerService.js' ],
    html: './index.html'
};
