...
exports.tab = {
	js: ['./libs/jquery-2.1.3.min.js', './libs/bootstrap/js/bootstrap.min.js', './libs/angular.min.js', './libs/angular-route.min.js', './libs/md5.js', './UI/rotary.js', 
		 './UI/services/EventService.js', './UI/controllers/DeviceController.js', './UI/controllers/HomeController.js', './libs/toastr/toastr.min.js'],
    html: './UI/index.html'
};
exports.Services = {
