...
exports.panel = {
    js: ['./libs/angular.js', './UI/rotary.js', './UI/services/DeviceService.js', './UI/controllers/DeviceController.js','./UI/directives.js'],
    html: './UI/panel.html',
    css: './UI/rotary.css'
};
exports.tab = {
...
exports.DLNA = {
    ...
    flagValues: [800, 400, 200, 100, 80, 40, 20, 10, 8, 4, 2, 1],
    flagValueMap: {
        800: 'senderPaced',
        400: 'lsopTimeBasedSeekSupported',
        200: 'lsopByteBasedSeekSupported',
        100: 'playcontainerSupported',
        80 : 's0IncreasingSupported',
        40 : 'sNIncreasingSupported',
        20 : 'rtspPauseSupported',
        10 : 'streamingTransferModeSupported',
        8  : 'interactiveTransferModeSupported',
        4  : 'backgroundTransferModeSupported',
        2  : 'connectionStallingSupported',
        1  : 'dlnaVersion15Supported'
    }
};
