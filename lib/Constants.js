...
exports.panel = {
    js: ['./libs/angular.min.js', './UI/panel.js', './UI/services/EventService.js', './UI/controllers/PanelController.js'],
    html: './UI/panel.html',
    css: './UI/panel.css'
};
exports.tab = {
	js: ['./libs/jquery-2.1.3.min.js', './libs/bootstrap/js/bootstrap.min.js', './libs/angular.min.js', './libs/angular-route.min.js', './libs/md5.js', './libs/toastr/toastr.min.js', './UI/rotary.js', 
		'./UI/Directives.js', './UI/controllers/DeviceController.js', './UI/controllers/HomeController.js', './UI/controllers/AboutController.js', './UI/controllers/DeviceInfoController.js', './UI/controllers/DeviceListController.js', './UI/services/PubSub.js',
		'./UI/controllers/IndexController.js', './UI/controllers/DeviceSettingsController.js', './UI/controllers/PlaylistController.js', './UI/services/EventService.js', './UI/services/PubSub.js' ],
    html: './UI/index.html'
};
exports.Services = {
    MatchStick: 'matchstickService',
    Chromecast: 'chromecastService',
    Firestick: 'firestickService',
    AVTransport: 'avTransportService',
    MediaRenderer: 'mediaRendererService',
    GenericDevice: 'genericDeviceService',
    WFA: 'wfaService',
    GenericDevice: 'genericDeviceService'
};
