...
exports.tab = {
	js: ['./libs/jquery-2.1.3.min.js', './libs/bootstrap/js/bootstrap.min.js', './libs/angular.min.js', './libs/angular-route.min.js', './libs/md5.js', './libs/toastr/toastr.min.js', './UI/omniscience.js',
		...
		'./UI/controllers/IndexController.js', './UI/controllers/DeviceSettingsController.js', './UI/controllers/PlaylistController.js', './UI/services/EventService.js', './UI/services/PubSub.js', './UI/controllers/ConnectionManager.js', './UI/services/ConnectionManagerService.js' ],
    html: './UI/index.html'
};
