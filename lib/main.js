...
//todo: remove string.format and replace with es6 template strings
//todo: remove requestjs and replace with fetch
...
exports.main = function main() {
    ...
    var componentFactory = require("./Factories/ComponentFactory");

    httpServer.registerPathHandler("/test",function(request,response){
        var ScriptableInputStream = componentFactory.createScriptableInputStream();
        ScriptableInputStream.init(request._bodyInputStream);
        console.log(ScriptableInputStream.read(request._headers._headers["content-length"][0]));
