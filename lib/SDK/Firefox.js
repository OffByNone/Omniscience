...
exports.getWifiMonitor = function getWifiMonitor(){
...
exports.getMimeService = function getMimeService(){
	return Cc["@mozilla.org/uriloader/external-helper-app-service;1"].getService(Ci.nsIMIMEService);
};
exports.getDNSService = function getDNSService(){
...
exports.getTransportService = function getTransportService(){
