...
exports.tab = {
	js: ['./libs/jquery-2.1.3.min.js', './libs/bootstrap/js/bootstrap.min.js', './libs/angular.min.js', './libs/angular-route.min.js', './libs/md5.js',
		...
		'./controllers/MatchStickSettings.js', './controllers/Playlist.js', './controllers/Playback.js', './controllers/Capabilities.js',
