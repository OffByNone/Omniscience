...
exports.tab = {
	js: ['./libs/jquery-2.1.3.min.js', './libs/bootstrap/js/bootstrap.min.js', './libs/angular.min.js', './libs/angular-route.min.js', './libs/md5.js', './libs/bootstrap-slider-4.8.3/bootstrap-slider.min.js', './libs/angular-bootstrap-slider-0.1.2/slider.js',
		'./omniscience.js', './Directives.js',
		'./controllers/DeviceController.js', './controllers/HomeController.js', './controllers/AboutController.js', './controllers/DeviceInfoController.js', './controllers/DeviceListController.js',
		'./controllers/IndexController.js', './controllers/MatchStickSettings.js', './controllers/PlaylistController.js', './controllers/PlaybackController.js', './controllers/CapabilitiesController.js',
		...
		'./services/StubFactory.js', './services/FileService.js', './services/InformationService.js', './services/PersistenceService.js', './services/MatchStickMessageGenerator.js'
	],
	html: './index.html'
};
