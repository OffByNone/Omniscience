	...
	createDevice: function createDevice(location, headers) {
        ...
        this._request({
            ...
            onComplete: (response) => {
                ...
                else if(responseObj.device.servicelist.service.servicetype === constants.ServiceTypes["AV Transport"] || 
                        (typeof responseObj.device.servicelist.service.some === "function" && responseObj.device.servicelist.service.some(x=> x.servicetype === constants.ServiceTypes["AV Transport"])))
