...
const ServiceInfoFactory = Class({
    initialize: function initialize(fetch, DOMParser, xmlParser, utilities, md5) {
        this._fetch = fetch;
    ...
    getDetailedServiceInformation: function getDetailedServiceInformation(serviceInfo){
