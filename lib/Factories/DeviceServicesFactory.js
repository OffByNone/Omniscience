...
const { AVTransportService } = require('../Services/Devices/AVTransportService');
...
const DeviceServicesFactory = Class({
    ...
    createDeviceServices: function createDeviceServices(){
        return new DeviceServices(this.createMatchStickService(), this.createChromecastService(), this.createFirestickService(), this.createAVTransportService(), this.createGenericDeviceService(), this._factory.createHttpServer());
    },
