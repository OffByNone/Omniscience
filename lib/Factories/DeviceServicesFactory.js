...
const DeviceServicesFactory = Class({
    ...
    createDeviceServices: function createDeviceServices(){
        return new DeviceServices(this.createMatchStickService(), this.createChromecastService(), this.createFirestickService(), this.createGenericDeviceService(), this._factory.createHttpServer());
    },
