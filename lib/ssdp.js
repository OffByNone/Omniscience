...
const SSDP = Class({
    extends: EventTarget,
    _socket: Cc['@mozilla.org/network/udp-socket;1'].createInstance(Ci.nsIUDPSocket), // http://dxr.mozilla.org/mozilla-central/source/netwerk/base/public/nsIUDPSocket.idl
