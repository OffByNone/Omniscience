...
class TransportService extends EventTarget {
    constructor (emitter, transportService, scriptableInputStream, inputStreamPump) {
    ...
    onDataAvailable(request, context, inputStream, offset, count) {
        ...
        this._emitter.emit(this, 'dataReceived', data);
    }
    open(ip, port){
