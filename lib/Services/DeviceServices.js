...
const DeviceServices = Class({
    extends: EventTarget,
    initialize: function initialize(defer, emitter, fxosWebServer, httpd, matchstickService, chromecastService, firestickService, mediaRendererService, genericDeviceService){
        ...
        this[Constants.Services.MediaRenderer].on("SomethingHappened", ( device, request ) => this._emitter.emit(this, "SomethingHappened", device, request));
