...
class DeviceServices {
    constructor (eventer, serviceInfoFactory, executableServiceFactory, subscriptionService, fxosWebServer, matchStickService){
    ...
    subscribe(subscriptionUrl, subscriptionId, serviceHash, serverIP, timeout){
        ...
        this._fxosWebServer.registerPath(directResponsesTo, (request) => {
