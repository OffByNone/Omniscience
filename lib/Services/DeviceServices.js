...
class DeviceServices {
    constructor (eventer, serviceInfoFactory, executableServiceFactory, subscriptionService, httpServer, httpResponder, matchStickService){
    ...
    subscribe(subscriptionUrl, subscriptionId, serviceHash, serverIP, timeout) {
		//todo: this and unsubscribe probably belong in the subscription service
        ...
        this._httpServer.registerPath(directResponsesTo, (request, resolve) => {
        	this._eventer.emit("deviceServices.UPnPEvent", serviceHash, request.body);
