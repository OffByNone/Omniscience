...
const SubscriptionService = Class({
    ...
    unsubscribe: function unsubscribe (subscriptionUrl, eventSubscriptionId){
    	if(!subscriptionUrl || !eventSubscriptionId) return { then: function(){} }; //todo: better validation, also validate some fields on subscribe too.  Also return some failed promise
