...
const AVTransportService = Class({
	...
	getMediaInfo: function getMediaInfo(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this.serviceType), this.serviceType, "GetMediaInfo", { InstanceID: device.instanceId }
							  	...
							  	var xml = response.xml.querySelector("Envelope Body GetMediaInfoResponse");
							  	if(xml)
							  		var mediaInfo = {
							  			writeStatus: this._xmlParser.getTextFromXml(xml,"WriteStatus"),
							  			recordMedium: this._xmlParser.getTextFromXml(xml,"RecordMedium"),
							  			playMedium: this._xmlParser.getTextFromXml(xml,"PlayMedium"),
							  			nextURIMetaData: this._xmlParser.getTextFromXml(xml,"NextURIMetaData"),
							  			nextURI: this._xmlParser.getTextFromXml(xml,"NextURI"),
							  			currentURIMetaData: this._xmlParser.getTextFromXml(xml,"CurrentURIMetaData"),
							  			currentURI: this._xmlParser.getTextFromXml(xml,"CurrentURI"),
							  			mediaDuration: this._xmlParser.getTextFromXml(xml,"MediaDuration"),
							  			nrTracks: this._xmlParser.getTextFromXml(xml,"NrTracks"),
							  			_raw: response.text
							  		};
	...
	getTransportInfo: function getTransportInfo(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this.serviceType),
								...
								{ InstanceID: device.instanceId}
									...
									var xml = response.xml.querySelector("Envelope Body GetTransportInfoResponse");
									if(xml)
										var transportInfo = {
											currentTransportState: this._xmlParser.getTextFromXml(xml,"CurrentTransportState"),
											currentTransportStatus: this._xmlParser.getTextFromXml(xml,"CurrentTransportStatus"),
											currentSpeed: this._xmlParser.getTextFromXml(xml,"CurrentSpeed"),
											_raw: response.text
										};
	...
	getPositionInfo: function getPositionInfo(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this.serviceType),
								...
								{ InstanceID: device.instanceId}
							  	...
							  	var xml = response.xml.querySelector("Envelope Body GetPositionInfoResponse");
							  	if(xml)
							  		var positionInfo = {
							  			track: this._xmlParser.getTextFromXml(xml,"Track"),
							  			trackDuration: this._xmlParser.getTextFromXml(xml,"TrackDuration"),
							  			trackMetaData: this._xmlParser.getTextFromXml(xml,"TrackMetaData"),
							  			trackURI: this._xmlParser.getTextFromXml(xml,"TrackURI"),
							  			relTime: this._xmlParser.getTextFromXml(xml,"RelTime"),
							  			absTime: this._xmlParser.getTextFromXml(xml,"AbsTime"),
							  			relCount: this._xmlParser.getTextFromXml(xml,"RelCount"),
							  			absCount: this._xmlParser.getTextFromXml(xml,"AbsCount"),
							  			_raw: response.text
							  		};
	...
	getDeviceCapabilities: function getDeviceCapabilities(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this.serviceType),
								...
								{ InstanceID: device.instanceId}
							  	...
							  	var xml = response.xml.querySelector("Envelope Body GetDeviceCapabilitiesResponse") || { querySelector: function () {} };
							  	var playMedia = this._xmlParser.getTextFromXml(xml,"PlayMedia");
							  	var recMedia = this._xmlParser.getTextFromXml(xml,"RecMedia");
							  	var recQualityModes = this._xmlParser.getTextFromXml(xml,"RecQualityModes");
	...
	getTransportSettings: function getTransportSettings(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this.serviceType),
								...
								{ InstanceID: device.instanceId}
							  	...
							  	var xml = response.xml.querySelector("Envelope Body GetTransportSettingsResponse");
							  	if(xml)
							  		var transportSettings = {
							  			playMode: this._xmlParser.getTextFromXml(xml,"PlayMode"),
							  			recQualityMode: this._xmlParser.getTextFromXml(xml,"RecQualityMode"),
							  			_raw: response.text
							  		};
	...
	getCurrentTransportActions: function getCurrentTransportActions(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this.serviceType),
								...
								{ InstanceID: device.instanceId}
							  	...
							  	var actions = this._xmlParser.getTextFromXml(response.xml,"Envelope Body GetCurrentTransportActionsResponse Actions");
