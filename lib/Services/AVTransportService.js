...
const AVTransportService = Class({
	extends: EventTarget,
    initialize: function initialize(emitter, soapService, subscriptionService) {
    ...
    loadMedia: function loadMedia(device, serverAddress, fileUri){
        return this._soapService.post(Utilities.getControlUrl(device, this._serviceType), 
                               this._serviceType, 
                               "SetAVTransportURI",
    ...
    subscribe: function subscribe(device){
        this._subscriptionService.subscribe(Utilities.getEventSubUrl(device, this._serviceType), "http://192.168.1.2:8080/test");
    },
    unsubscribe: function unsubscribe(device){
        this._subscriptionService.subscribe(Utilities.getEventSubUrl(device, this._serviceType), "http://192.168.1.2:8080");
    }
});
