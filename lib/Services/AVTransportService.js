...
const AVTransportService = Class({
	...
	loadMedia: function loadMedia(device, serverAddress, fileUri){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this._serviceType),
                               this._serviceType,
                               "SetAVTransportURI",
	...
	getMediaInfo: function getMediaInfo(device){
		var deferred = this._defer();
		this._soapService.post(this._utilities.getControlUrl(device, this._serviceType), this._serviceType, "GetMediaInfo", { InstanceID: device.instanceId }
                              ).then(response => {
	...
	getCurrentTransportActions: function getCurrentTransportActions(device){
		...
		this._soapService.post(this._utilities.getControlUrl(device, this._serviceType),
                                ...
                                { InstanceID: device.instanceId}
                              	...
                              	var actions = (response.xml.querySelector("Envelope Body GetCurrentTransportActionsResponse Actions") || {}).innerHTML;
