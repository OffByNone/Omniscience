...
class SSDPClient {
    constructor(eventPrefix, eventer, utilities, udpSocket, bufferProvider) {
    ...
    search(service) {
        var message = this._bufferProvider.createBuffer(this._utilities.format(Constants.MSearch, this.multicastIP, this.multicastPort, service));
