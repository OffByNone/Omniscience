...
const TransportService = Class({
	...
	initialize: function intialize(options) {
		...
		this.transportService = IOC.createTransportService();
		this.scriptableInputStream = IOC.createScriptableInputStream();
		this.inputStreamPump = IOC.createInputStreamPump();
