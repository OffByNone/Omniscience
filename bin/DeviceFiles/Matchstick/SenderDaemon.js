...
var Firefox = require('../SDK/AddonSdk');
var parser = Firefox.createDOMParser();
var timers = Firefox.timers();
var XMLHttpRequest = Firefox.XMLHttpRequest();
...
**/
var MessageChannel = function MessageChannel(wsURL) {
	var self = this;
	var wsServer = wsURL;
...
var Sender = (function () {
	...
	_createClass(Sender, [{
		key: 'load',
		value: function load(receiverAppPath, fileUri) {
			var _this = this;
